...
const SchemeSchema = z.object({
  ...
  aphorism: z
    .string()
    .describe(
      "One or two short sentences compressing this specific polarity into a line worth repeating. Under 25 words. Your own words only — never a quotation, never attributed to anyone."
    ),
...
The APHORISM compresses this one polarity into a line someone would repeat. Three
rules, and they are strict:

- Write your own. Never quote anyone, never attribute, never imitate a named
  author closely enough to be mistaken for a quotation. A fabricated quotation
  handed to a professional in front of their client is the worst thing this tool
  could do.
- Make it specific to THIS pairing. "Balance is the key to life" would fit any
  scheme, which means it says nothing. Someone who has read it should be able to
  reconstruct which polarity it came from.
- Earn the turn. The good ones name the trap plainly and then invert it:
  "What is never risked is not kept safe. It is only kept still."
  Plain words, hard edges. No mysticism, no rhetorical questions, no second-person
  advice, and nothing that reads as a fortune cookie.`;
