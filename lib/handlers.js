...
function referenceExpand(query) {
  ...
  // The client turns this into an offer of the worked theses, so the message
  // states the fact and leaves the remedy to the UI.
  if (!entry) throw fail(`No worked analysis of “${query}” in this build.`, 404);
