    ...
    variants: [
      ...
      },
      {
        ...
        scheme: {
          ...
          aphorism:
            "An institution that cannot hear what went wrong will go on doing it, safely.",
          tension:
    ...
    variants: [
      {
        ...
        scheme: {
          ...
          aphorism:
            "Enter every market and you will be present in all of them and formidable in none.",
          tension:
      ...
      },
      {
        ...
        scheme: {
          ...
          aphorism:
            "A promise kept forever is a hand that can never be used for anything else.",
          tension:
    ...
    variants: [
      ...
      },
      {
        ...
        scheme: {
          ...
          aphorism:
            "Disclose everything and you have hidden the one thing that mattered, in plain sight.",
          tension:
    ...
    variants: [
      ...
      },
      {
        ...
        scheme: {
          ...
          aphorism:
            "Give without a limit and you will not be valued. You will be budgeted for.",
          tension:
    ...
    variants: [
      {
        ...
        scheme: {
          ...
          aphorism:
            "Deciding faster is only an advantage where deciding wrongly can be undone.",
          tension:
      ...
      },
      {
        ...
        scheme: {
          ...
          aphorism:
            "A shorter cycle does not teach you more. It repeats you more often.",
          tension:
